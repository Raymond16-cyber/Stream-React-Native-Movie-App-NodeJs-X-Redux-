    ...
    <SafeAreaView className='bg-primary flex-1'>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className='px-4 mt-6'>
          ...
          <TouchableOpacity className='bg-dark-100 rounded-2xl p-4 flex-row items-center justify-between'>
            <View className='flex-row items-center flex-1'>
              <MaterialCommunityIcons name='fingerprint' size={20} color='#FF8C42' />
              <View className='ml-4 flex-1'>
                <Text className='text-white font-semibold'>Biometric Login</Text>
                <Text className='text-light-300 text-xs mt-1'>Use Face ID or fingerprint to sign in</Text>
              </View>
            </View>
